...
public class Lambda04 {/*
    ...
    olan POJO clas craete edip main method içinde 5 farklı obj'den List create ediniz.
            */
    public static void main(String[] args) {//universite adinda objeerimiz olducreate ettik
        ...
        System.out.println(notOrt74BykUnv(unv));//tru /false dondurecegi icin sout icine aldik
        System.out.println("\n   ***   ");
    ...
    public static boolean notOrt74BykUnv(List<Universite> unv) {// parantesli yere  nerden aldigini yaziyor return lu method calisiyoruz

        return unv.
                stream().
                allMatch(t -> t.getNotOrt() > 74);//allmatch hepsine bak dedigimiz icin kullaniyoruz hepsi buyuk degil oyuzden false doner
        //anymatch kullansaydik tek biratanesinde varmi diye bakardi
    }
    ...
    public static List<Universite> ogrSayiBkSirala(List<Universite> unv) {//return typli
        return unv.// bogazici itu butun unv getiriyor
                stream().
                sorted(Comparator.comparing(Universite::getOgrSayisi).//ogrenci sayisini getirdi
                        reversed()).//buyukten kucuge siraladi
                        collect(Collectors.toList());//topla akistaki elemanlari listin icine demek list doncegi icin return type list olur
        //pojo classtan to string degistirip sadece unv adiylada siralayabiliriz
    }

    public static void ogrSayiBkSiralaVoid(List<Universite> unv) {//voidli
    ...
    public static List<Universite> notOrtBkSialiIlkUc(List<Universite> unv) {
        return unv.
                stream().//akısa alındı
                        ...
                        limit(3).//akısın ilk 3 elemanı alındı sadece limit yazdirmiyor referanslarini veriyor oyuzden toplamak lazim
